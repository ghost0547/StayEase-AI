...
function HeroSection() {
  return (
    <section className="relative py-12 sm:py-20 lg:py-28 px-4 sm:px-6 lg:px-8 overflow-hidden">
      <div className="max-w-7xl mx-auto z-10 relative">
        ...
        >
          {/* Left Text & CTAs */}
          <div className="flex flex-col items-start space-y-5 sm:space-y-6 text-left max-w-full">
            <motion.div
              variants={fadeInUp}
              className="inline-flex items-center gap-2 px-3.5 sm:px-4 py-2 rounded-full bg-cyan-500/10 border border-cyan-500/30 text-cyan-300 text-xs sm:text-sm font-semibold backdrop-blur-md shadow-inner max-w-full truncate"
            >
              <HiSparkles className="w-4 h-4 text-cyan-400 animate-pulse shrink-0" />
              <span className="truncate">Next-Gen AI Travel Platform</span>
            </motion.div>

            <motion.h1
              variants={fadeInUp}
              className="text-3xl sm:text-5xl lg:text-6xl font-extrabold text-white tracking-tight leading-[1.15] break-words"
            >
            ...
            <motion.p
              variants={fadeInUp}
              className="text-sm sm:text-lg text-slate-300 max-w-xl font-normal leading-relaxed"
            >
            ...
            >
              <motion.div whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.96 }} className="w-full sm:w-auto">
                <Link
                  to="/#homestays"
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 sm:px-7 py-3.5 rounded-2xl bg-gradient-to-r from-cyan-500 via-teal-500 to-emerald-500 hover:from-cyan-400 hover:to-teal-400 text-slate-950 font-bold text-sm sm:text-base shadow-lg shadow-cyan-500/25 transition-all duration-200"
                >
              ...
              <motion.div whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.96 }} className="w-full sm:w-auto">
                <Link
                  to="/ai-planner"
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 sm:px-7 py-3.5 rounded-2xl bg-slate-900/80 hover:bg-slate-800/90 border border-slate-700/80 hover:border-cyan-500/50 text-cyan-300 font-semibold text-sm sm:text-base backdrop-blur-md shadow-md transition-all duration-200 text-center"
                >
                  <HiSparkles className="w-5 h-5 text-cyan-400 shrink-0" />
            ...
            <motion.div
              variants={fadeInUp}
              className="pt-6 border-t border-slate-800/80 w-full flex flex-wrap items-center gap-y-3 gap-x-4 sm:gap-x-6 text-xs sm:text-sm text-slate-400"
            >
              <div className="flex items-center gap-2 font-medium">
                <HiCheckBadge className="w-4 h-4 text-cyan-400 shrink-0" />
                <span>Instant Itineraries</span>
              </div>
              <div className="flex items-center gap-2 font-medium">
                <HiBuildingStorefront className="w-4 h-4 text-teal-400 shrink-0" />
          ...
          <motion.div variants={fadeInUp} className="relative flex items-center justify-center w-full mt-4 lg:mt-0">
            <motion.div
              animate={{ y: [0, -8, 0] }}
            ...
            >
              ...
              <div className="relative rounded-3xl bg-slate-900/70 border border-slate-700/70 backdrop-blur-2xl p-5 sm:p-8 shadow-2xl space-y-5">
                <div className="flex items-center justify-between border-b border-slate-800 pb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-400">Gemini Powered Itineraries</p>
                    </div>
                  </div>
                  <span className="px-2.5 py-1 rounded-full text-xs font-semibold bg-cyan-500/10 text-cyan-300 border border-cyan-500/30 shrink-0">
                    99.4% Match
                  </span>
                </div>
                ...
                <div className="space-y-3">
                  <div className="p-3 sm:p-3.5 rounded-2xl bg-slate-800/60 border border-slate-700/50 flex items-center justify-between gap-2">
                    <div className="flex items-center gap-2.5 min-w-0">
                      <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-cyan-500/20 text-cyan-300 flex items-center justify-center text-xs font-bold border border-cyan-500/30 shrink-0">
                        01
                      </div>
                      <div className="min-w-0">
                        <p className="text-xs font-semibold text-white truncate">Ubud Eco-Villa & Spa</p>
                        <p className="text-[11px] text-slate-400 flex items-center gap-1 truncate">
                          <HiMapPin className="w-3 h-3 text-cyan-400 shrink-0" /> Bali • Nature Retreat
                        </p>
                      </div>
                    </div>
                    <span className="text-xs font-bold text-emerald-400 shrink-0">★ 4.96</span>
                  </div>

                  <div className="p-3 sm:p-3.5 rounded-2xl bg-slate-800/60 border border-slate-700/50 flex items-center justify-between gap-2">
                    <div className="flex items-center gap-2.5 min-w-0">
                      <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-teal-500/20 text-teal-300 flex items-center justify-center text-xs font-bold border border-teal-500/30 shrink-0">
                        02
                      </div>
                      <div className="min-w-0">
                        <p className="text-xs font-semibold text-white truncate">AI Day Plan Generation</p>
                        <p className="text-[11px] text-slate-400 flex items-center gap-1 truncate">
                          <HiCalendar className="w-3 h-3 text-teal-400 shrink-0" /> Morning Trek & Spice Tour
                        </p>
                      </div>
                    </div>
                    <span className="text-xs font-semibold text-cyan-300 shrink-0">Generated</span>
                  </div>
                </div>

                {/* Simulated AI Prompt */}
                <div className="p-3 sm:p-3.5 rounded-xl bg-slate-950/80 border border-cyan-500/30 flex items-center gap-2.5 text-xs text-slate-300 shadow-inner">
              ...
              {/* Floating Chip 1 (Hidden on small mobile to prevent overflow) */}
              <motion.div
                animate={{ y: [0, -6, 0] }}
                transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
                className="hidden sm:flex absolute -top-5 -right-2 px-3.5 py-2 rounded-2xl bg-slate-900/90 border border-cyan-500/40 backdrop-blur-xl shadow-xl flex items-center gap-2 text-xs font-semibold text-slate-200 z-20"
              >
              ...
              {/* Floating Chip 2 (Hidden on small mobile to prevent overflow) */}
              <motion.div
                animate={{ y: [0, 6, 0] }}
                transition={{ duration: 5, repeat: Infinity, ease: "easeInOut" }}
                className="hidden sm:flex absolute -bottom-5 -left-2 px-3.5 py-2 rounded-2xl bg-slate-900/90 border border-teal-500/40 backdrop-blur-xl shadow-xl flex items-center gap-2 text-xs font-semibold text-slate-200 z-20"
              >
              ...
              >
                ...
                >
                  <div className="space-y-4">
                    <div
                      className={`w-12 h-12 rounded-2xl bg-gradient-to-br ${card.iconGradient} border border-slate-700/60 flex items-center justify-center ${card.iconColor} shadow-md`}
                    >
                  ...
                  <div className="pt-5 mt-5 border-t border-slate-800/60 flex items-center justify-between text-xs font-semibold text-slate-400">
                    <span className="text-cyan-400">StayEase Core</span>
                    <HiArrowRight className="w-4 h-4 text-slate-500 shrink-0" />
                  </div>
                </motion.div>
              </motion.div>
            );
...
function MissionSection() {
  return (
    <section className="py-12 sm:py-20 px-4 sm:px-6 lg:px-8 relative z-10">
      <div className="max-w-7xl mx-auto">
        <div className="rounded-3xl bg-slate-900/70 border border-slate-800/80 backdrop-blur-2xl p-6 sm:p-12 lg:p-16 shadow-2xl relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center relative z-10">
            ...
            <div className="lg:col-span-7 space-y-5 sm:space-y-6 text-left">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-teal-500/10 border border-teal-500/20 text-teal-300 text-xs sm:text-sm font-semibold">
                <HiAcademicCap className="w-4 h-4 text-teal-400 shrink-0" />
              ...
              <div className="p-4 sm:p-6 rounded-2xl bg-slate-950/60 border-l-4 border-cyan-400 border-y border-r border-slate-800/80 text-slate-200 text-xs sm:text-lg leading-relaxed font-medium italic shadow-inner">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 pt-2">
                <div className="p-3.5 sm:p-4 rounded-2xl bg-slate-800/40 border border-slate-700/50">
                  <div className="text-cyan-400 font-extrabold text-xl sm:text-2xl">100%</div>
                  <div className="text-xs text-slate-400 font-medium mt-1">Personalized Itineraries</div>
                </div>
                <div className="p-3.5 sm:p-4 rounded-2xl bg-slate-800/40 border border-slate-700/50">
                  <div className="text-teal-400 font-extrabold text-xl sm:text-2xl">Sub-Sec</div>
                  <div className="text-xs text-slate-400 font-medium mt-1">AI Recommendation Time</div>
                </div>
                <div className="p-3.5 sm:p-4 rounded-2xl bg-slate-800/40 border border-slate-700/50">
                  <div className="text-emerald-400 font-extrabold text-xl sm:text-2xl">Verified</div>
            ...
            <div className="lg:col-span-5 flex justify-center">
              <div className="relative w-full max-w-md">
                <div className="rounded-3xl bg-slate-950/80 border border-slate-800 p-5 sm:p-6 space-y-4 shadow-xl">
                  ...
                  {/* Flow Node 1 */}
                  <div className="p-3.5 sm:p-4 rounded-2xl bg-slate-900 border border-slate-800 flex items-center gap-3">
                    <div className="w-9 h-9 rounded-xl bg-cyan-500/20 text-cyan-400 flex items-center justify-center font-bold text-sm shrink-0">
                      01
                    </div>
                    <div>
                      <h4 className="text-xs sm:text-sm font-bold text-white">Traveler Input & Preferences</h4>
                      <p className="text-[11px] text-slate-400">Location, duration, budget & style</p>
                    </div>
                  </div>
                  ...
                  {/* Flow Node 2 */}
                  <div className="p-3.5 sm:p-4 rounded-2xl bg-slate-900 border border-cyan-500/40 flex items-center gap-3 shadow-md shadow-cyan-500/10">
                    <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-cyan-500 to-teal-500 text-slate-950 flex items-center justify-center font-bold text-sm shrink-0">
                      <HiSparkles className="w-4 h-4" />
                    </div>
                    <div>
                      <h4 className="text-xs sm:text-sm font-bold text-cyan-300">Gemini AI Synthesis</h4>
                      <p className="text-[11px] text-slate-400">Contextual itinerary & stay matching</p>
                    </div>
                  </div>
                  ...
                  <div className="p-3.5 sm:p-4 rounded-2xl bg-slate-900 border border-slate-800 flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="text-xs sm:text-sm font-bold text-white">Perfect Travel Plan Output</h4>
                      <p className="text-[11px] text-slate-400">Day-by-day plan & stay reservation link</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                >
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div
                        className={`w-11 h-11 sm:w-12 sm:h-12 rounded-2xl bg-slate-800/90 border border-slate-700/60 flex items-center justify-center ${tech.iconColor} text-xl sm:text-2xl shadow-inner shrink-0`}
                      >
                        <Icon />
                      </div>
                      <span className="px-3 py-1 rounded-full text-[10px] sm:text-[11px] font-semibold bg-slate-800 text-slate-300 border border-slate-700">
                        {tech.category}
                      </span>
                    </div>

                    <h3 className="text-lg sm:text-xl font-bold text-white tracking-tight">{tech.name}</h3>
                    <p className="text-xs sm:text-sm text-slate-400 leading-relaxed">
                      {tech.description}
                    </p>
                  </div>

                  <div className="pt-4 mt-4 border-t border-slate-800/60 flex items-center justify-between text-xs text-slate-500 font-medium">
                    <span>Verified Component</span>
                    <HiCheck className="w-4 h-4 text-cyan-400 shrink-0" />
                  </div>
                </div>
              </motion.div>
            );
...
function ProjectOverviewSection() {
  ...
  return (
    <section className="py-12 sm:py-20 px-4 sm:px-6 lg:px-8 relative z-10">
      <div className="max-w-7xl mx-auto">
        <div className="rounded-3xl bg-gradient-to-br from-slate-900/90 via-slate-900/70 to-slate-950/90 border border-slate-800/80 backdrop-blur-2xl p-6 sm:p-12 lg:p-16 shadow-2xl space-y-8 sm:space-y-12">
          {/* Header */}
          <div className="text-center max-w-3xl mx-auto space-y-4">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-300 text-xs sm:text-sm font-semibold">
              <HiAcademicCap className="w-4 h-4 text-emerald-400 shrink-0" />
            ...
            <p className="text-slate-300 text-sm sm:text-lg leading-relaxed font-normal max-w-2xl mx-auto">
            ...
            {highlights.map((item, index) => {
              ...
              return (
                <motion.div
                  key={index}
                  whileHover={{ y: -4 }}
                  className="p-5 sm:p-6 rounded-2xl bg-slate-950/60 border border-slate-800 hover:border-cyan-500/40 space-y-3 transition-colors duration-200"
                >
  ...
  return (
    <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 relative z-10">
      <div className="max-w-5xl mx-auto">
        <div className="relative rounded-3xl bg-gradient-to-r from-slate-900 via-slate-900 to-slate-950 border border-cyan-500/30 p-8 sm:p-16 text-center space-y-6 sm:space-y-8 shadow-2xl overflow-hidden">
          {/* Ambient Glow */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 sm:w-96 h-80 sm:h-96 bg-cyan-500/15 rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="relative z-10 flex flex-col sm:flex-row items-center justify-center gap-3.5 sm:gap-4">
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="w-full sm:w-auto">
              <Link
                to="/#homestays"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-7 py-3.5 rounded-2xl bg-gradient-to-r from-cyan-500 via-teal-500 to-emerald-500 hover:from-cyan-400 hover:to-teal-400 text-slate-950 font-extrabold text-sm sm:text-base shadow-xl shadow-cyan-500/25 transition-all duration-200"
              >
                <span>Explore Homestays</span>
                <HiArrowRight className="w-5 h-5 shrink-0" />
              </Link>
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="w-full sm:w-auto">
              <Link
                to="/ai-planner"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-7 py-3.5 rounded-2xl bg-slate-900/90 hover:bg-slate-800 border border-slate-700 hover:border-cyan-500/50 text-cyan-300 font-bold text-sm sm:text-base backdrop-blur-md shadow-lg transition-all duration-200 text-center"
              >
                <HiSparkles className="w-5 h-5 text-cyan-400 shrink-0" />
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-b from-[#0F172A] via-[#0D1527] to-[#111827] text-white font-sans relative overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-10 left-10 w-72 sm:w-96 h-72 sm:h-96 bg-cyan-500/15 rounded-full blur-3xl pointer-events-none"
      />
      <motion.div
        animate={{
          y: [20, -20, 20],
        ...
        className="absolute top-1/3 -right-20 w-72 sm:w-[30rem] h-72 sm:h-[30rem] bg-teal-500/15 rounded-full blur-3xl pointer-events-none"
      />
      <motion.div
        animate={{
          x: [-30, 30, -30],
        ...
        className="absolute bottom-20 left-1/3 w-72 sm:w-[28rem] h-72 sm:h-[28rem] bg-emerald-500/15 rounded-full blur-3xl pointer-events-none"
      />
